...
;; (defcustom clang-format-executable "/opt/homebrew/bin/clang-format"
;;   "Location of the clang-format executable.
...
(defcustom clang-format-fallback-style "file"
...
uses the function `buffer-file-name'."
  ...
  ;; this is the hack to ensure our local ~/.clang-format style is used.
